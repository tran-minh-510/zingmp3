                    ...
                    <div className="text-center">
                        <div className="detail-playlist_thumbnail pb-3">
                            ...
                            >
                                ...
                                />
                                <div
                                    className={`overlay d-flex justify-content-center align-items-center ${isPlaying && "rounded-circle"
                                        }`}
                                    ref={overlayRef}
                                >
                                </div>
                                <div className="overlay-icon" ref={overlayIconRef} style={Object.assign(
                                    {},
                                    isPlaying && { display: "block" }
                                )}>
                                    <span>
                                        {isPlaying ? (
                                            <Audio
                        ...
                        <div className="detail-playlist_btn-ramdom-song">
                            <button className="w-100 rounded-5 p-2 fw-semibold">
                                <span className="p-2">
                                    <i className={listIcon?.start} />
                                </span>
                                Phát ngẫu nhiên
